...
def _load_shareholder_rewards_config(config_data: Dict) -> Dict:
    ...
    rewards_proxy_url = advanced_rewards.get("proxy_url", "") or advanced_crawler.get("default_proxy", "")
    ...
    return {
        ...
        "PROXY_URL": rewards_proxy_url,
        "API_URL": advanced_rewards.get("api_url", "https://www.cninfo.com.cn/new/hisAnnouncement/query"),
        "DETAIL_BASE_URL": advanced_rewards.get("detail_base_url", "https://static.cninfo.com.cn/"),
